...
class DistanceFormatterTests: XCTestCase {
    ...
    func testDistanceFormatters_DE() {
        ...
        assertDistance(2500, displayed: "2.5 km", quantity: "2.5")
        assertDistance(2900, displayed: "2.9 km", quantity: "2.9")
        assertDistance(3000, displayed: "3 km", quantity: "3")
        assertDistance(3500, displayed: "4 km", quantity: "4")
    }
