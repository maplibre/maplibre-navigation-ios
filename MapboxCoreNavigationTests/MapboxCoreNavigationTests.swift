...
class MapboxCoreNavigationTests: XCTestCase {
    ...
    func testFailToReroute() {
        ...
        expectation(forNotification: .routeControllerWillReroute, object: navigation) { _ -> Bool in
            true
        }
        
        expectation(forNotification: .routeControllerDidFailToReroute, object: navigation) { _ -> Bool in
            true
        }
