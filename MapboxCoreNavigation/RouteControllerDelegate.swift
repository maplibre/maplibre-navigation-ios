...
public protocol RouteControllerDelegate: AnyObject {
    ...
    /**
      ...
      */
    func routeControllerGetDirections(from location: CLLocation, along progress: RouteProgress, completion: @escaping (_ mostSimilarRoute: Route?, _ routes: [Route]?, _ error: Error?) -> Void)
...
extension RouteControllerDelegate {
    func routeController(_ routeController: RouteController, shouldRerouteFrom location: CLLocation) -> Bool {
        true
    }
